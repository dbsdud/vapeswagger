...
class EnableAdrManage extends Component{
    ...
    async componentWillMount(){
        const response = await axios.get('http://15.164.160.236:8080/admanage/EnableAdManage/1')
        this.setState({
    ...
    async handleSearch() {
        ...
        const response = await axios.get(`http://15.164.160.236:8080/admanage/adSearch/enable/${adSearch}/1`)
    ...
    async pagingPrev() {
        ...
        if(adSearch===""){
            const response = await axios.get(`http://15.164.160.236:8080/admanage/EnableAdManage/${page}`)
            this.setState({
                adListResponse:response.data.adList,
                pagingResponse:response.data.paging,
            ...
            const response = await axios.get(`http://15.164.160.236:8080/admanage/adSearch/enable/${adSearch}/${page}`)
            if(response.status ===200) {
                this.setState({
                    adListResponse:response.data.adSearchList,
                    pagingResponse:response.data.paging,
                ...
                <div className="adminLnb">
                    ...
                    <div className="adminLnb-sub">
                        <div className="adminContainer">
                            ...
                            <Link to="/EnableAdManage" className="adminActive">노출 광고관리</Link>
                ...
                <div className="adminContainer adminBody-footer">
                    ...
                    <div className="adminRow adminShadow-custom">
                        ...
                        <div className="adminCol-md-11">
                            <p><button type="button" className="adminBtn adminBtn-warning" onClick={this.handleDisable.bind(this)}>비활성화</button></p>
...
export default EnableAdrManage