...
if(this2.location.query!==undefined){
  ...
  if(this2.location.query.ntDetailResponse !== undefined && this2.location.query.commentNo === undefined &&this2.location.query.recommentNo === undefined ){
    noticeNo =  this2.location.query.ntDetailResponse.noticeNo;
    boardWriter = this2.location.query.ntDetailResponse.noticeWriter;
    boardTitle = this2.location.query.ntDetailResponse.noticeTitle;
    boardRegdate = this2.location.query.ntDetailResponse.noticeRegdate;
  }
  if(this2.location.query.ntDetailResponse===undefined){
    if(this2.location.query.noticeNo !== undefined && this2.location.query.commentNo !== undefined &&this2.location.query.recommentNo === undefined ){
     noticeNo=this2.location.query.noticeNo;
